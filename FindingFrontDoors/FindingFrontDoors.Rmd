---
title: "<a href='https://github.com/mca91/kausalanalyse_slides/raw/WiSe25/FindingFrontDoors/FindingFrontDoors.pdf'>Finding front doors</a>"
...
- However, people buying the lottery got their wealth from many sources like inheritance, working, etc., these sources are not related to _whether you win the lottery_ 
- So we need not consider these as backdoors on variation 
]
...
```{r, echo=F, cache=F, out.extra = 'style="display:block; margin-right:auto; margin-left:auto;"', fig.height=3.5, out.width='45%', dpi=190, fig.cap=paste0(': Causal diagram of Influence of Charter School on Grades'), fig.align='center',include=FALSE}
coord_dag <- list(
  x = c(a = 1, b = 3, c = 2 ),
  y = c(a = 1, b = 1, c = 2 )
)
...
```{r, echo=F, cache=F, fig.cap=paste0(fig_counter(), ': Causal diagram of Influence of Charter School on Grades')}
m <- DiagrammeR::grViz("dot_files/Charter_Students.dot", height = 200, width = "100%")
...
```{r, echo=F, cache=F, out.extra = 'style="display:block; margin-right:auto; margin-left:auto;"', fig.height=4, out.width='65%', dpi=190, fig.cap=paste0(': Causal diagram of influence of Charter schools on grades '), fig.align='center',include=FALSE}
coord_dag <- list(
  x = c(a = 1, b = 3, c = 2, d= 1 ),
  y = c(a = 1, b = 1, c = 2, d=2 )
)
...
```{r, echo=F, cache=F, fig.cap=paste0(fig_counter(), ': Causal diagram of influence of Charter schools on grades')}
m <- DiagrammeR::grViz("dot_files/Charter_Students_pg9.dot", height = 250, width = "100%")
widgetframe::frameableWidget(m)
```
...
Natural experiments are a real-world setting in which randomisation of treatment and control conditions has already been done by nature or by other factors that are outside our control
...
<br>
```{r, echo=F, cache=F, out.extra = 'style="display:block; margin-right:auto; margin-left:auto; margin-top:2%"', fig.height=4, out.width='60%', dpi=190, fig.cap=paste0(': Causal Diagram for Exogenous Source of Variation'), fig.align='center',include=FALSE}
coord_dag <- list(
  x = c(a = 1, b = 3, c = 2, d = 1 ),
  y = c(a = 1, b = 1, c = 2, d = 2 )
)
...
```{r, echo=F, cache=F, fig.cap=paste0(fig_counter(), ': Causal Diagram for Exogenous Source of Variation')}
m <- DiagrammeR::grViz("dot_files/Natural_Randomness.dot", height = 250, width = "100%")
widgetframe::frameableWidget(m)
```
...
```{r, echo=F, cache=F, out.extra = 'style="display:block; margin-right:auto; margin-left:auto;"', fig.height=5.5, out.width='55%', dpi=190, fig.cap=paste0(': Causal Diagram of effect of Air Pollution on number of people driving'), fig.align='center',include=FALSE}
coord_dag <- list(
...
```{r, echo=F, cache=F, fig.cap=paste0(fig_counter(), ': Causal Diagram of effect of Air Pollution on number of people driving')}
m <- DiagrammeR::grViz("dot_files/AirPollution_Driving.dot", height = 400, width = "100%")
widgetframe::frameableWidget(m)
```
]]
...
- We have to assume that the **expansion only affected hospital compensation** in order to consider **variation in compensation driven by the Medicaid expansion as being exogenous**.
...
```{r , echo=F, cache=F, out.extra = 'style="display:block; margin-right:auto; margin-left:auto;"', fig.height=4, out.width='55%', dpi=190, fig.cap=paste0(': Causal Diagram when using the front door method'), fig.align='center',include=FALSE}
coord_dag <- list(
  x = c(a = 1, b = 2, c = 3, d = 2  ),
  y = c(a = 1, b = 1, c = 1, d = 2 )
)
...
```{r, echo=F, cache=F, fig.cap=paste0(fig_counter(), ': Causal Diagram when using the front door method')}
m <- DiagrammeR::grViz("dot_files/Treatment_Outcome.dot", height = 370, width = "100%")
widgetframe::frameableWidget(m)
```
...
```{r , echo=F, cache=F, out.extra = 'style="display:block; margin-right:auto; margin-left:auto;"', fig.height=4, out.width='55%', dpi=190, fig.cap=paste0(': Causal Diagram for Smoking and Cancer'), fig.align='center',include=FALSE}
coord_dag <- list(
  x = c(a = 1, b = 2, c = 3, d = 2  ),
  y = c(a = 1, b = 1, c = 1, d = 2 )
)
...
```{r, echo=F, cache=F, fig.cap=paste0(fig_counter(), ': Causal Diagram for Smoking and Cancer')}
m <- DiagrammeR::grViz("dot_files/Smoking_Cancer.dot", height = 350, width = "100%")
widgetframe::frameableWidget(m)
```
