...
```{r, echo=F, cache=F, out.extra = 'style="display:block; margin-right:auto; margin-left:auto;"', fig.height=3.5, out.width='45%', dpi=190, fig.cap=paste0(fig_counter(), ': Causal diagram of Influence of Charter School on Grades'), fig.align='center',include=FALSE}
coord_dag <- list(
  x = c(a = 1, b = 3, c = 2 ),
  y = c(a = 1, b = 1, c = 2 )
)
...
```{r, echo=F, cache=F, out.extra = 'style="display:block; margin-right:auto; margin-left:auto;"', fig.height=4, out.width='65%', dpi=190, fig.cap=paste0(fig_counter(), ': Causal diagram of influence of Charter schools on grades '), fig.align='center',include=FALSE}
coord_dag <- list(
  x = c(a = 1, b = 3, c = 2, d= 1 ),
  y = c(a = 1, b = 1, c = 2, d=2 )
)
...
<br>
```{r, echo=F, cache=F, out.extra = 'style="display:block; margin-right:auto; margin-left:auto; margin-top:2%"', fig.height=4, out.width='60%', dpi=190, fig.cap=paste0(fig_counter(), ': Causal Diagram for Exogenous Source of Variation'), fig.align='center',include=FALSE}
coord_dag <- list(
  x = c(a = 1, b = 3, c = 2, d = 1 ),
  y = c(a = 1, b = 1, c = 2, d = 2 )
)
...
```{r, echo=F, cache=F, out.extra = 'style="display:block; margin-right:auto; margin-left:auto;"', fig.height=5.5, out.width='55%', dpi=190, fig.cap=paste0(fig_counter(), ': Causal Diagram of effect of Air Pollution on number of people driving'), fig.align='center',include=FALSE}
coord_dag <- list(
...
```{r , echo=F, cache=F, out.extra = 'style="display:block; margin-right:auto; margin-left:auto;"', fig.height=4, out.width='55%', dpi=190, fig.cap=paste0(fig_counter(), ': Causal Diagram when using the front door method'), fig.align='center',include=FALSE}
coord_dag <- list(
  x = c(a = 1, b = 2, c = 3, d = 2  ),
  y = c(a = 1, b = 1, c = 1, d = 2 )
)
...
```{r , echo=F, cache=F, out.extra = 'style="display:block; margin-right:auto; margin-left:auto;"', fig.height=4, out.width='55%', dpi=190, fig.cap=paste0(fig_counter(), ': Causal Diagram for Smoking and Cancer'), fig.align='center',include=FALSE}
coord_dag <- list(
  x = c(a = 1, b = 2, c = 3, d = 2  ),
  y = c(a = 1, b = 1, c = 1, d = 2 )
)
