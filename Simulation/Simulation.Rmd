...
Power analysis is the process of trying to figure out if the amount of information present in the data is enough. While there are calculators and analytic methods out there for performing power analysis, power analysis is very commonly done by simulation, especially for non-experimental studies.
]]
