...
m <- DiagrammeR::grViz("dot_files/Treatment_Outcome_pg7.dot", height = 350, width = "100%")
...
m <- DiagrammeR::grViz("dot_files/Treatment_Outcome_pg33.dot", height = 350, width = "100%")
widgetframe::frameableWidget(m)
```
