...
---
## Regression discontinuity with OLS
#### Linear shape may not be flexible enough

<div class="thecontainer">
 <div id="observablehq-svg-b56d5ea5"></div>
  <div class="right-aligned">
    <ul style="list-style-type:none;">
      <li><div id="observablehq-viewof-bw_daten_LLRU-b56d5ea5"></div></li>
      <li><div id="observablehq-styles-b56d5ea5"></div></li>
    </ul>
</div>
...
import define from "https://api.observablehq.com/d/74f688f1119258d6@84.js?v=4";
new Runtime().module(define, name => {
  if (name === "svg") return new Inspector(document.querySelector("#observablehq-svg-b56d5ea5"));
  if (name === "viewof bw_daten_LLRU") return new Inspector(document.querySelector("#observablehq-viewof-bw_daten_LLRU-b56d5ea5"));
  if (name === "styles") return new Inspector(document.querySelector("#observablehq-styles-b56d5ea5"));
});
</script>
...
- A distribution that seems to have a dip just to one side of the cutoff, with those observations sitting just on the other side, may indicate manipulation
