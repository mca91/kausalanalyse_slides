...
```{r, echo=F, cache=F, out.extra = 'style="display:block; margin-right:auto; margin-left:auto;"', fig.height=5, fig.width=12, out.width='100%', out.height='95%', dpi=190, fig.cap=paste0(fig_counter(), ': Regression discontinuity step-by-step'), fig.align='center'}
suppressWarnings({
set.seed(1000)
...
.blockquote[
```{r, echo=F, cache=F, warning=F, out.extra = 'style="display:block; margin-right:auto; margin-left:auto;"'}
gt <- causaldata::gov_transfers
