...
```{r , echo=F, cache=F, out.extra = 'style="display:block; margin-right:auto; margin-left:auto;"', fig.height=4, out.width='60%', dpi=190, fig.cap=paste0(fig_counter(), ': Regression Discontinuity with Different Polynomials'), fig.align='center'}
suppressWarnings({
set.seed(1000)
tib <- tibble(X = runif(200)) %>%
  mutate(Y = rnorm(200)*.05 + case_when(
...
```{r, echo=F, warning=F, cache=F, out.extra = 'style="display:block; margin-right:auto; margin-left:auto;"', fig.height=4, fig.width=8, out.width='70%', dpi=190, fig.cap=paste0(fig_counter(), ': Distribution of the binned running variable'), fig.align='center'}
...
```{r, echo=F, cache=F, out.extra = 'style="display:block; margin-right:auto; margin-left:auto;"', fig.height=4, fig.width=10, out.width='80%', dpi=190, fig.cap=paste0(fig_counter(), ': Log leave duration or proportion claiming leave again and pre-leave earnings'), fig.align='center'}
