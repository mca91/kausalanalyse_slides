---
title: "<a href='https://github.com/mca91/kausalanalyse_slides/raw/SoSe24/Identification/Identification.pdf'>Identification</a>"
...
ggplot(df %>% filter(Hair == "Brown"), aes(x = logIncome, linetype = Hair)) +
  ...
  theme(text         = element_text(size = 16),
        ...
        legend.position.inside = c(-.1005, .1),
...
**Clearly non-drinkers would have very low mortality rates!?**
