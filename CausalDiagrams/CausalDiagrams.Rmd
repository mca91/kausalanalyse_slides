...
---
##Causal Diagrams &mdash; A simple Example
...
To get our answer, we have to dig out *that* part of the variation in crime and block out the alternative explanations.

---
## Causal Diagrams: Moderators

- $X$ → $Y$ and $Z$ → $Y$
- However, this could be consistent with any of the following two DGPs:
 - $Y = .2X + .3Z$
 - $Y= 2X + 3XZ$ 
 
 ...and infinite many more!
- We say that $Z$ has a *moderating influence* on the effect of $X$ on $Y$
