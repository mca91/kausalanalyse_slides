...
```{r, echo=F, cache=F, out.extra = 'style="display:block; margin-right:auto; margin-left:auto; margin-top:50px;"', fig.height=3, out.width='65%', dpi=190, fig.cap=paste0(fig_counter(), ': Causal Diagram'), fig.align='center',include=FALSE}
coord_dag <- list(
  x = c(a = 1, b = 3, c = 5, d = 7 ),
  y = c(a = 2, b = 1, c = 2, d = 1)
)
