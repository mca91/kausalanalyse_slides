...
- E. g., suppose we have  $Y_i \sim [0, a]$ and $E(Y) = \dfrac{a + b}{2} = \dfrac{a}{2}$
- Plugging in the (G)MM sample estimator $\mu$ for $E(Y)$ results in $\displaystyle \mu = \dfrac{1}{N} \sum_{i = 1}^{N} Y_i = \dfrac{a}{2}$
- Rearranging yields $a = 2 \cdot \mu = 2 \cdot \left( \dfrac{1}{N} \sum_{i = 1}^{N} Y_i \right)$
]
