---
title: "<a href='https://github.com/mca91/kausalanalyse_slides/raw/SoSe24/IV/IV.pdf'>Instrumental variables</a>"
...
- E.g., suppose we have  $Y_i \sim U[0, a]$ such that $E(Y) = \frac{a + b}{2} = \frac{a}{2}$
- Plugging in the sample average yield $\mu$ for $E(Y)$ results in $\displaystyle \mu = \frac{1}{N} \sum_{i = 1}^{N} Y_i = \dfrac{\hat{a}}{2}$
