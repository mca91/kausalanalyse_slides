---
title: "<a href='https://github.com/mca91/kausalanalyse_slides/raw/WiSe25/EventStudies/EventStudies.pdf'>Event Studies</a>"
...
```{r , echo=F, cache=F, out.extra = 'style="display:block; margin-right:auto; margin-left:auto;"', fig.height=3.5, out.width='65%', dpi=190, fig.cap=paste0(': Causal diagram that event studies work for'), fig.align='center',include=FALSE}
coord_dag <- list(
  x = c(a = 1, b = 0, c = 1, d = 2),
  y = c(a = 1, b = 0, c = 0, d = 0)
)
...
```{r, echo=F, cache=F, fig.cap=paste0(fig_counter(), ': Causal diagram that event studies work for')}
m <- DiagrammeR::grViz("dot_files/Time_outcome.dot", height = 300, width = "100%")
...
- The before-event and after-event states are compared to get the effect of the treatment. 
...
- In the first figure, it looks like the treatment had an immediate positive effect on the outcome, with the black line far above the gray right after the treatment, but then that effect fades out over time and the lines come back together.
...
- The only reason the price should have any sort of sharp change is if there is surprising new information revealed about the company
  ...
  &rarr; This can be considered a *treatment* !
...
- At this point we have effects for each group &mdash; this could be an immediate effect of 
    ...
    - the coefficient of $After$ on slide 19, or 
    
    - an average effect over the entire post-event period, or a cumulative effect. 

- From there the distribution of effects across all the groups can be inspected (and summarized, think averages)
...
<div class="thecontainer">
  <div id="observablehq-theplot-f58190fb"></div>
  <div class="right-aligned">
    <ul style="list-style-type:none;">
      <li><div id="observablehq-viewof-phi-f58190fb"></div></li>
      <li><div id="observablehq-viewof-theta-f58190fb"></div></li>
      <li><div id="observablehq-viewof-start-f58190fb"></div></li>
      <li><div id="observablehq-viewof-sigma-f58190fb"></div></li>
      <li><div id="observablehq-viewof-n-f58190fb"></div></li>
      <li><div id="observablehq-viewof-mu-f58190fb"></div></li>
    </ul>
  </div>
</div>
...
import define from "https://api.observablehq.com/d/9bdf2b5b3279afc0@238.js?v=4";
new Runtime().module(define, name => {
  if (name === "viewof phi") return new Inspector(document.querySelector("#observablehq-viewof-phi-f58190fb"));
  if (name === "viewof theta") return new Inspector(document.querySelector("#observablehq-viewof-theta-f58190fb"));
  if (name === "viewof start") return new Inspector(document.querySelector("#observablehq-viewof-start-f58190fb"));
  if (name === "viewof sigma") return new Inspector(document.querySelector("#observablehq-viewof-sigma-f58190fb"));
  if (name === "viewof n") return new Inspector(document.querySelector("#observablehq-viewof-n-f58190fb"));
  if (name === "viewof mu") return new Inspector(document.querySelector("#observablehq-viewof-mu-f58190fb"));
  if (name === "theplot") return new Inspector(document.querySelector("#observablehq-theplot-f58190fb"));
  return ["ymean","arma11","combinedData","newYDomain","errors"].includes(name);
});
</script>
