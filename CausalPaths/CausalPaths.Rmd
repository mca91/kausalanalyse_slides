...
3. Repeat step 2 until you either... 
    ...
    come to a variable that has been already visited (_a loop which is not a path_)
...
- If we had data in which nobody uses drugs, we had no variation in *Drugs*, and thus none of the relationship between *Wine* and *Lifespan* could possibly be driven by *Drugs*. This is a *closed* path.
...
- *Closing a paths* means that we can remove all the variation due to a variable along that path: 

 **We eliminates a threat to the identification of the variation we are interested in!**
...
- To identify the answer to our research question, what we need to close all the bad paths while leaving all the good paths ppen.
...
Consider *Income* and *Drugs*. We list all paths between *Wine* and *Drugs*
