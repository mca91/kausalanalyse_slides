...
- Other variables besides *hours* that cause *time* also cause *hours*. We omit *time* to have *hours* affect *classes* directly: we still have all those causes of *time* affecting *hours*. 
