...
```{r, echo=F, cache=F, out.extra = 'style="color:black; display:block; margin-right:auto; margin-left:auto;"', fig.height=2, out.width='70%', dpi=190, fig.cap=paste0( ': A simple causal diagram'), include=FALSE}
coord_dag <- list(
  x = c(Y = 3, X = 1),
  y = c(Y = 1, X = 1)
)
...
```{r, echo=F, cache=F, out.extra = 'style="color:black; display:block; margin-right:auto; margin-left:auto; margin-top:15px"', fig.width=12, fig.height=4.5, dpi=190, fig.cap=paste0(': Online classes'), include=F}
coord_dag <- list(
...
```{r, echo=F, cache=F, out.extra = 'style="color:black; display:block; margin-right:auto; margin-left:auto; margin-top:15px"', fig.width=12, fig.height=4.5, dpi=190, fig.cap=paste0(': Simplified causal diagram for online classes'),include=FALSE}
coord_dag <- list(
