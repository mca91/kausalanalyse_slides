---
title: "<a href='https://github.com/mca91/kausalanalyse_slides/raw/SoSe24/DrawingCausalDiagrams/DrawingCausalDiagrams.pdf'>Drawing causal diagrams</a>"
...
Hence, drawing our own causal diagram will come down to putting our idea of what the DGP is onto paper (or a computer screen).

```{r, echo=F, cache=F, out.extra = 'style="color:black; display:block; margin-right:auto; margin-left:auto;"', fig.height=2, out.width='70%', dpi=190, fig.cap=paste0(fig_counter(), ': A simple causal diagram'), include=FALSE}
coord_dag <- list(
  x = c(Y = 3, X = 1),
  y = c(Y = 1, X = 1)
)
...
m <- DiagrammeR::grViz("dot_files/Simple_Causal_Diagram.dot", height = 80, width = "100%")
...
- *prefs* $\to$ *classes*, *race* $\to$ *DropOut*, *gender* $\to$ *DropOut*, *WebAccess* $\to$ *classes*, and so on.
...
```{r, echo=F, cache=F, out.extra = 'style="color:black; display:block; margin-right:auto; margin-left:auto; margin-top:15px"', fig.width=12, fig.height=4.5, dpi=190, fig.cap=paste0(fig_counter(), ': Online classes'), include=F}
coord_dag <- list(
...
```{r, echo=F, cache=F, fig.cap=paste0(fig_counter(), ': Online classes')}
m <- DiagrammeR::grViz("dot_files/OnlineClasses.dot", height = 450, width = "100%")
widgetframe::frameableWidget(m)
```
...
```{r, echo=F, cache=F, out.extra = 'style="color:black; display:block; margin-right:auto; margin-left:auto; margin-top:15px"', fig.width=12, fig.height=4.5, dpi=190, fig.cap=paste0(fig_counter(), ': Simplified causal diagram for online classes'),include=FALSE}
coord_dag <- list(
...
```{r, echo=F, cache=F, fig.cap=paste0(fig_counter(), ': Simplified causal diagram for online classes')}
m <- DiagrammeR::grViz("dot_files/Simplified_CD.dot", height = 400, width = "100%")
widgetframe::frameableWidget(m)
```
...
- Alternatively, if we just focus on the part of the variable driven by randomness, the effect cannot loop back on itself! 
...
```{r, echo=F, cache=F, fig.height=4, out.width='100%', dpi=190, fig.cap=paste0(fig_counter(), ': A simple loop in a causal diagram'),include=FALSE}
coord_dag <- list(
  x = c(a = 1, b = 3),
  y = c(a = 1, b = 2)
)
...
```{r, echo=F, cache=F, fig.cap=paste0(fig_counter(), ': A simple loop in a causal diagram')}
m <- DiagrammeR::grViz("dot_files/loop_1.dot", height = 300, width = "100%")
widgetframe::frameableWidget(m)
```
...
```{r, echo=F, cache=F, fig.height=4, out.width='100%', dpi=190, fig.cap=paste0(fig_counter(), ': Another representation of the loop'),include=FALSE}
coord_dag <- list(
  x = c(a = 4, b = 1, c = 4, d = 1),
  y = c(a = 3, b = 1, c = 1, d = 3)
)
...
```{r, echo=F, cache=F, fig.cap=paste0(fig_counter(), ': Another representation of the loop')}
m <- DiagrammeR::grViz("dot_files/loop_2.dot", height = 300, width = "100%")
widgetframe::frameableWidget(m)
```
]]]
