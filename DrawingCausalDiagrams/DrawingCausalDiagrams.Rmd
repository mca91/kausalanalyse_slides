...
m <- DiagrammeR::grViz("dot_files/Simple_Causal_Diagram.dot", height = 140, width = "100%")
...
m <- DiagrammeR::grViz("dot_files/loop_1.dot", height = 200, width = "100%")
widgetframe::frameableWidget(m)
```
...
m <- DiagrammeR::grViz("dot_files/loop_2.dot", height = 200, width = "100%")
widgetframe::frameableWidget(m)
```
]]]
