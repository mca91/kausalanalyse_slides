...
<div class="thecontainer">
  ...
  <div class="right-aligned">
    ...
    <ul>
      <li>Use the checkbox to toggle between highlighting of the matched dataset (1-to-k matching of control to treatment units with replacement) and the (potential) matches of the currently selected observation. 
