...
<div class="thecontainer">
  ...
  <div class="right-aligned">
    ...
    <ul>
      ...
      <li> \(SD(V1) = SD(V2) = \sqrt{120}\approx 10.95\). So \(\text{MHD} = 1\) is equivalent to \(\text{ED} = 10.95\) for \(\text{Corr}(V1,V2)=0\) (why?).</li>
...
<script type="module">
import {Runtime, Inspector} from "https://cdn.jsdelivr.net/npm/@observablehq/runtime@5/dist/runtime.js";
import define from "https://api.observablehq.com/d/4da2bc277fec4645@873.js?v=4";
new Runtime().module(define, name => {
