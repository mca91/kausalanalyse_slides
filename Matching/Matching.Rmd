...
- The weights may be constructed as: Give a weights of 1 to *everyone* who is treated, $80/500 = 0.16$ to all untreated men, and $20/500 = 0.04$ to all untreated women
...
#### 1-to-k Euclidian distance matching (with replacement)
...
- Kernel functions are functions that given a difference, returns a weight. The highest value is at 0 (no difference), and then the valued uniform weights declines as the value move away from 0 in either direction
