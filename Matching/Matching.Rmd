...
- Kernel functions are functions that given a difference, returns a weight. The highest value is at 0 (no difference), and then the value declines as the value move away from 0 in either direction
