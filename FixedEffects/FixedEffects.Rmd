...
- The value of $R^2$ gives an insight to the interpretation. $R^2$ is a measure based on how much variation there is in the residuals relative to the dependent variable. The value of $R^2$ lies between 0 and 1 with 0 means that the fitted regressions explains the data well and 0 means it does not
...
---
# `r stairs` Clustered standard errors
